...
const dictionaries = {
	zh: {
		...
		"admin.settingsTitle": "运行设置",
		"admin.settingsCopy": "修改上传能力和对象存储后端。Secret 不会回显，留空会保留现有值。",
		"admin.saveSettings": "保存设置",
		"admin.settingsSaved": "设置已保存。",
		"admin.settingsFailed": "设置读取或保存失败。",
		"admin.storageBackend": "对象存储",
		"admin.storageR2": "Cloudflare R2",
		"admin.storageS3": "S3 兼容 API",
		"admin.customPickupCodeEnabled": "允许自定义取件码",
		"admin.customPickupCodeHint": "关闭后前台只会自动生成取件码，直接调用 API 也会被拒绝。",
		"admin.objectCacheTtl": "对象缓存秒数",
		"admin.objectCacheTtlHint": "0 表示关闭；开启后下载/预览仍会扣次数，但缓存命中不读 R2/S3。",
		"admin.invalidCacheTtl": "对象缓存秒数必须是大于等于 0 的整数。",
		"admin.s3Endpoint": "S3 Endpoint",
		"admin.s3Bucket": "Bucket",
		"admin.s3Region": "Region",
		"admin.s3AccessKeyId": "Access Key ID",
		"admin.s3SecretAccessKey": "Secret Access Key",
		"admin.s3SessionToken": "Session Token",
		"admin.s3ForcePathStyle": "使用 path-style URL",
		"admin.s3ForcePathStyleHint": "大多数 S3 兼容服务建议开启；AWS virtual-hosted-style 可关闭。",
		"admin.secretPreserved": "已保存，留空保持不变",
		"admin.optional": "可选",
		"admin.storageMissingS3": "请填写 S3 endpoint、bucket、region 和 access key。",
		"admin.storageMissingSecret": "请填写 S3 secret access key。",
		"admin.saving": "保存中",
	...
	en: {
		...
		"admin.settingsTitle": "Runtime Settings",
		"admin.settingsCopy": "Change upload capabilities and object storage backend. Secrets are never shown; leave them blank to keep existing values.",
		"admin.saveSettings": "Save Settings",
		"admin.settingsSaved": "Settings saved.",
		"admin.settingsFailed": "Failed to read or save settings.",
		"admin.storageBackend": "Object storage",
		"admin.storageR2": "Cloudflare R2",
		"admin.storageS3": "S3-compatible API",
		"admin.customPickupCodeEnabled": "Allow custom pickup codes",
		"admin.customPickupCodeHint": "When disabled, the site only auto-generates pickup codes and direct API calls are rejected.",
		"admin.objectCacheTtl": "Object cache seconds",
		"admin.objectCacheTtlHint": "0 disables it. Downloads/previews still count, but cache hits do not read R2/S3.",
		"admin.invalidCacheTtl": "Object cache seconds must be an integer greater than or equal to 0.",
		"admin.s3Endpoint": "S3 Endpoint",
		"admin.s3Bucket": "Bucket",
		"admin.s3Region": "Region",
		"admin.s3AccessKeyId": "Access Key ID",
		"admin.s3SecretAccessKey": "Secret Access Key",
		"admin.s3SessionToken": "Session Token",
		"admin.s3ForcePathStyle": "Use path-style URL",
		"admin.s3ForcePathStyleHint": "Recommended for most S3-compatible services; disable for AWS virtual-hosted-style.",
		"admin.secretPreserved": "Saved; leave blank to keep it",
		"admin.optional": "Optional",
		"admin.storageMissingS3": "Enter S3 endpoint, bucket, region, and access key.",
		"admin.storageMissingSecret": "Enter the S3 secret access key.",
		"admin.saving": "Saving",
